    ...
    public sealed class FaceTrackFrame : IDisposable, ICloneable
    {
        ...
        public Vector3DF Rotation
        {
            get
            {
                ...
                coordinates += "Time: " + date1.ToString("yyyyyyyyMMddHHmmssfff") + " Rotation:    (Pitch: " + Math.Round(rotationXyz.X, 0).ToString() + "°, Yaw: " + Math.Round(rotationXyz.Y, 0).ToString() + "°, Roll: " + Math.Round(rotationXyz.Z, 0).ToString() + ")" + "\r\n";
                coordinates += "Time: " + date1.ToString("yyyyyyyyMMddHHmmssfff") + " Translation: (Zero point in X-Axis: " + Math.Round(translationXyz.X * 1000, 0).ToString() + " mm, Zero-point in Y-Axis: " + Math.Round(translationXyz.Y * 1000, 0).ToString() + " mm, Distance from Kinect: " + Math.Round(translationXyz.Z * 1000, 0).ToString() + " mm)" + "\r\n";

                //Console.WriteLine(coordinates);

                //Console.WriteLine("Time: " + date1.ToString("yyyyyyyyMMddHHmmssfff") + " Rotation: (Pitch: " + Math.Round(rotationXyz.X, 0).ToString() + "°, Yaw: " + Math.Round(rotationXyz.Y, 0).ToString() + "°, Roll: " + Math.Round(rotationXyz.Z, 0).ToString() + ")");
                //Console.WriteLine("Time: " + date1.ToString("yyyyyyyyMMddHHmmssfff") + " Translation: (Zero point in X-Axis: " + Math.Round(translationXyz.X * 1000, 0).ToString() + " mm, Zero-point in Y-Axis: " + Math.Round(translationXyz.Y * 1000, 0).ToString() + " mm, Distance from Kinect: " + Math.Round(translationXyz.Z * 1000, 0).ToString() + " mm)");
                return rotationXyz;
            }
        }

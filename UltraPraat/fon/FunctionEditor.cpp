...
static void menu_cb_getFrames (EDITOR_ARGS) {
    ...
    if (my data) {
        ...
        for (int i=1; i<=frameCount; i++) {
            if ((currentTime + frameDuration >= my d_startSelection) && (currentTime <= my d_endSelection) || (currentTime - frameDuration >= my d_startSelection) && (currentTime <= my d_endSelection)) {
